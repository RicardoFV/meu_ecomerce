    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('usuario.cadastrar.cliente')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row mb-0 text-center">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <?php echo e(__('Registrar-se')); ?>

                                </button>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">
                                    <?php echo e(__('Já tenho Cadastro')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projetos\laravel\meu_ecomerce\resources\views/auth/register.blade.php ENDPATH**/ ?>
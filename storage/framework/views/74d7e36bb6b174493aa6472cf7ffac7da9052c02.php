...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <!-- link css -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/estiloadm.css')); ?>">
        ...
        <script src="<?php echo e(asset('js/busca_cep.js')); ?>"></script>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="<?php echo e(route('categoria')); ?>">Categoria</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('usuario.listar')); ?>">Usuário</a>
                                </div>
...
<?php /**PATH C:\Projetos\laravel\meu_ecomerce\resources\views/layouts/app.blade.php ENDPATH**/ ?>
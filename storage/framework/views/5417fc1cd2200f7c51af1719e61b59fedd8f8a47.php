        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a href="<?php echo e(route('cliente.tela_atualizar')); ?>" class="dropdown-item">Cliente</a>
                    </div>
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-5" href="<?php echo e(route('carrinho.listar')); ?>">
...
<?php /**PATH C:\Projetos\laravel\meu_ecomerce\resources\views/esqueleto_projeto/menu_principal.blade.php ENDPATH**/ ?>
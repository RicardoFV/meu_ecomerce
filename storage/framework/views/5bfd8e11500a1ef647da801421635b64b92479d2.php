    ...
    <form>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" id="cardholderName" value="<?php echo e($dados['nomecliente']); ?>" data-checkout="cardholderName" />    
            </div>

            <div class="form-group col-md-3">
                <label for="email">E-mail</label>
                <input type="email" class="form-control" id="email" value="<?php echo e($dados['emailCliente']); ?>" name="email" />   
            </div>

            <div class="form-group col-md-3">
                <label for="transaction_amount">Valor a Pagar</label>
                <input  class="form-control" name="transaction_amount" readonly="readonly" value="R$ <?php echo e($dados['valor_final']); ?>" id="transaction_amount" />    
            </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projetos\laravel\meu_ecomerce\resources\views/pagamentos/mercado_pago.blade.php ENDPATH**/ ?>
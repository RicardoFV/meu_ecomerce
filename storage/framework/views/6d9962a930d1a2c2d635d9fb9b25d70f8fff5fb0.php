...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Alterar Usuário')); ?></div>

                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('usuario.atualizar', $usuario->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" id="ativo" value="<?php echo e($usuario->ativo); ?>" name="ativo" value="1">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nome')); ?></label>

                            <div class="col-md-6">
                                <input id="name" type="text" value="<?php echo e($usuario->name); ?>" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" value="<?php echo e($usuario->email); ?>" type="email" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projetos\laravel\meu_estoque\resources\views/altera/usuario_altera.blade.php ENDPATH**/ ?>